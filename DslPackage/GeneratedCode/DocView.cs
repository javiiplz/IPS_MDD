...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </summary>
	internal partial class PracticaDERADocView : PracticaDERADocViewBase
	{
		/// <summary>
		/// Constructs a new PracticaDERADocView.
		/// </summary>
		public PracticaDERADocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PracticaDERADocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new PracticaDERADocView.
		/// </summary>
		protected PracticaDERADocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			PracticaDERADocDataBase docData = this.DocData as PracticaDERADocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for PracticaDERADocViewBase should be an PracticaDERADocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.PracticaDERADiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
