...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	[VSShell::ProvideToolWindow(typeof(PracticaDERAExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(PracticaDERAExplorerToolWindow), Constants.PracticaDERAEditorFactoryId)]
	[VSShell::ProvideStaticToolboxGroup("@PracticaDERAToolboxTab;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", "UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab")]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab",
					"@EntidadToolToolboxItem;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					"UPM_IPS.JGAJPTJJLProyectoIPS.EntidadToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"EntidadTool", 
					"@EntidadToolToolboxBitmap;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					0xff00ff,
					Index = 0)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab",
					"@AtributoToolToolboxItem;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					"UPM_IPS.JGAJPTJJLProyectoIPS.AtributoToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"AtributoTool", 
					"@AtributoToolToolboxBitmap;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					0xff00ff,
					Index = 1)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab",
					"@RelacionToolToolboxItem;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					"UPM_IPS.JGAJPTJJLProyectoIPS.RelacionToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"RelacionTool", 
					"@RelacionToolToolboxBitmap;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					0xff00ff,
					Index = 2)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab",
					"@EstiloPortalToolToolboxItem;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					"UPM_IPS.JGAJPTJJLProyectoIPS.EstiloPortalToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"EstiloPortalTool", 
	...
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab",
					...
					Index = 4)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxTab",
					"@EstiloCampoToolToolboxItem;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					"UPM_IPS.JGAJPTJJLProyectoIPS.EstiloCampoToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"EstiloCampoTool", 
					"@EstiloCampoToolToolboxBitmap;UPM_IPS.JGAJPTJJLProyectoIPS.Dsl.dll", 
					0xff00ff,
					Index = 5)]
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"PracticaDERA", typeof(PracticaDERAEditorFactory))]

	internal abstract partial class PracticaDERAPackageBase : DslShell::AsyncModelingPackage
	{
		protected global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxHelper toolboxHelper;	
		...
		protected async override System.Threading.Tasks.Task InitializeAsync(CancellationToken cancellationToken, IProgress<VSShell.ServiceProgressData> progress)
		{
			...
			this.RegisterEditorFactory(new PracticaDERAEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERAToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			PracticaDERACommandSet commandSet = new PracticaDERACommandSet(this);
			...
			PracticaDERAClipboardCommandSet clipboardCommandSet = new PracticaDERAClipboardCommandSet(this);
			await clipboardCommandSet.InitializeAsync(cancellationToken);
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(PracticaDERAExplorerToolWindow));
		...
		{
			if (toolWindowType == typeof(PracticaDERAExplorerToolWindow).GUID)
			{
				return this;
			}
...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADirectiveProcessor), global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADirectiveProcessor.PracticaDERADirectiveProcessorName, "A directive processor that provides access to PracticaDERA files")]
	[global::System.Runtime.InteropServices.Guid(Constants.PracticaDERAPackageId)]
	internal sealed partial class PracticaDERAPackage : PracticaDERAPackageBase
	{
	}
}