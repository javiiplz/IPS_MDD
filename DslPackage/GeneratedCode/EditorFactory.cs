...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.PracticaDERAEditorFactoryId)]
	internal partial class PracticaDERAEditorFactory : PracticaDERAEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new PracticaDERAEditorFactory.
		/// </summary>
		public PracticaDERAEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PracticaDERAEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected PracticaDERAEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new PracticaDERADocData(this.ServiceProvider, typeof(PracticaDERAEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new PracticaDERADocView(docData, this.ServiceProvider);
		}
	}
}
