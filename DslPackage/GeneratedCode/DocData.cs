...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </summary>
	internal partial class PracticaDERADocData : PracticaDERADocDataBase
	{
		/// <summary>
		/// Constructs a new PracticaDERADocData.
		/// </summary>
		public PracticaDERADocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a PracticaDERA document in memory.
	/// </summary>
	internal abstract partial class PracticaDERADocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new PracticaDERADocDataBase.
		/// </summary>
		protected PracticaDERADocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::UPM_IPS.JGAJPTJJLProyectoIPS.DiagramaWeb modelRoot = null;
			...
			global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERASerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::UPM_IPS.JGAJPTJJLProyectoIPS.DiagramaWeb modelRoot = this.RootElement as global::UPM_IPS.JGAJPTJJLProyectoIPS.DiagramaWeb;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADiagram diagram = diagrams[0] as global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::UPM_IPS.JGAJPTJJLProyectoIPS.DiagramaWeb modelRoot = (global::UPM_IPS.JGAJPTJJLProyectoIPS.DiagramaWeb)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERASerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERASerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERASerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERASerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
