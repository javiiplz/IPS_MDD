...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </summary>
	internal partial class PracticaDERACommandSet : PracticaDERACommandSetBase
	{
		/// <summary>
		/// Constructs a new PracticaDERACommandSet.
		/// </summary>
		public PracticaDERACommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PracticaDERACommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PracticaDERACommandSetBase.
		/// </summary>
		protected PracticaDERACommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPracticaDERAExplorerCommand,
				typeof(PracticaDERAEditorFactory).GUID);
		...
		{
			PracticaDERAExplorerToolWindow explorer = this.PracticaDERAExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PracticaDERADocData CurrentPracticaDERADocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PracticaDERADocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PracticaDERADocView CurrentPracticaDERADocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PracticaDERADocView;
			}
		}
		...
		/// </summary>
		protected PracticaDERAExplorerToolWindow PracticaDERAExplorerToolWindow
		{
			get
			{
				PracticaDERAExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PracticaDERAExplorerToolWindow), true) as PracticaDERAExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PracticaDERAExplorerToolWindow explorerWindow = this.PracticaDERAExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PracticaDERAClipboardCommandSet : PracticaDERAClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PracticaDERAClipboardCommandSet.
		/// </summary>
		public PracticaDERAClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PracticaDERAClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PracticaDERAClipboardCommandSetBase.
		/// </summary>
		protected PracticaDERAClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
