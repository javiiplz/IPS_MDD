...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </summary>
	public static partial class GeneradorRelacion
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)
				{
					if (candidateTarget is global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)
					{
						global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad sourceEntidad = (global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)candidateSource;
						global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad targetEntidad = (global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)candidateTarget;
						if(targetEntidad == null || sourceEntidad == null || global::UPM_IPS.JGAJPTJJLProyectoIPS.Relacion.GetLinks(sourceEntidad, targetEntidad).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)
				{
					if (target is global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)
					{
						global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad sourceAccepted = (global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)source;
						global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad targetAccepted = (global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad)target;
						DslModeling::ElementLink result = new global::UPM_IPS.JGAJPTJJLProyectoIPS.Relacion(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class RelacionToolConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new RelacionToolConnectAction for the given Diagram.
		/// </summary>
		public RelacionToolConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the RelacionToolConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new RelacionToolConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class RelacionToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the RelacionToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected RelacionToolConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder GeneradorRelacion.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return GeneradorRelacion.CanAcceptSource(sourceElement);
					}
					else
					{				
						return GeneradorRelacion.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				GeneradorRelacion.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class RelacionToolConnectionType : RelacionToolConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the RelacionToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			public RelacionToolConnectionType() : base() {}
		}
	}
}
