...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </remarks>
	public partial class PracticaDERAHelpKeywordHelper : PracticaDERAHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PracticaDERAHelpKeywordHelper.
		/// </summary>
		protected PracticaDERAHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PracticaDERAHelpKeywordHelper.
		/// </summary>
		public static PracticaDERAHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PracticaDERAHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PracticaDERAHelpKeywordHelperBase.
		/// </summary>
		protected PracticaDERAHelpKeywordHelperBase()
			: base() { }
