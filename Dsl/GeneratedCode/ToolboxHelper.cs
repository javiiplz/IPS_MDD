...
namespace UPM_IPS.JGAJPTJJLProyectoIPS
{
	...
	/// </remarks>
	public partial class PracticaDERAToolboxHelper : PracticaDERAToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new PracticaDERAToolboxHelper.
		/// </summary>
		public PracticaDERAToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class PracticaDERAToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify PracticaDERA toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new PracticaDERAToolboxHelperBase.
		/// </summary>
		protected PracticaDERAToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager.GetString("PracticaDERAToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "UPM_IPS.JGAJPTJJLProyectoIPS.EntidadToolToolboxItem":
					// Add EntidadTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.JGAJPTJJLProyectoIPS.EntidadToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.JGAJPTJJLProyectoIPS.Entidad.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.JGAJPTJJLProyectoIPS.AtributoToolToolboxItem":
					// Add AtributoTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.JGAJPTJJLProyectoIPS.AtributoToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
				...
				case "UPM_IPS.JGAJPTJJLProyectoIPS.RelacionToolToolboxItem":
					...
					break;
				case "UPM_IPS.JGAJPTJJLProyectoIPS.EstiloPortalToolToolboxItem":
					// Add EstiloPortalTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.JGAJPTJJLProyectoIPS.EstiloPortalToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.JGAJPTJJLProyectoIPS.EstiloPortal.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.JGAJPTJJLProyectoIPS.EstiloPaginaToolToolboxItem":
					// Add EstiloPaginaTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.JGAJPTJJLProyectoIPS.EstiloPaginaToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.JGAJPTJJLProyectoIPS.PracticaDERADomainModel));
